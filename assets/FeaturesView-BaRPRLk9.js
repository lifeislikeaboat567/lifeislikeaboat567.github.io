...
`,P={name:"FeaturesView",setup(e){return f(()=>{h()}),(a,o)=>(c(),v(m,{title:"Features",breadcrumb:[{label:"Page Sections",route:"/sections/page-sections/page-headers"},{label:"Features"}]},{default:d(()=>[s(g,{title:"Features 1",code:w(U),id:"feature-1"},{default:d(()=>[s(O)]),_:1},8,["code"])]),_:1}))}};export{P as default};
