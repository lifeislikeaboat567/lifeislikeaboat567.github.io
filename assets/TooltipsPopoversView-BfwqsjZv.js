...
`,F={name:"TooltipsPopoversView",setup(r){return l(()=>{v()}),(s,n)=>(p(),_(g,{title:"Tooltip & Popovers",breadcrumb:[{label:"Attention Catchers",route:"#"},{label:"Tooltip & Popovers"}]},{default:o(()=>[t(c,{title:"Popovers",code:d(W),id:"popovers"},{default:o(()=>[t(x)]),_:1},8,["code"]),t(c,{title:"Tooltips",code:d(j),id:"tooltips"},{default:o(()=>[t(N)]),_:1},8,["code"])]),_:1}))}};export{F as default};
