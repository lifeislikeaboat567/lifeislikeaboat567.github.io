...
`,U={name:"AvatarsView",setup(m){return g(()=>{n()}),(r,c)=>(l(),f(v,{title:"Avatars",breadcrumb:[{label:"Elements",route:"#"},{label:"Avatars"}]},{default:i(()=>[t(p,{title:"Avatar Group",code:e(E),id:"avatar-group"},{default:i(()=>[t(w)]),_:1},8,["code"]),t(p,{title:"Avatar Size",code:e(H),id:"avatar-size"},{default:i(()=>[t(D)]),_:1},8,["code"])]),_:1}))}};export{U as default};
