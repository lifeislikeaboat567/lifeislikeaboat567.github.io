...
`,k={name:"TypographyView",setup(t){return r(()=>{i()}),(a,I)=>(e(),p(o,{title:"Typography",breadcrumb:[{label:"Elements",route:"#"},{label:"Typography"}]},{default:s(()=>[l(c,{title:"Typography - Font Family Roboto",code:m(f),id:"typography-roboto",height:"600"},{default:s(()=>[l(y)]),_:1},8,["code"])]),_:1}))}};export{k as default};
