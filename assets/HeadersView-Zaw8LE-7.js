...
</template>`,J={name:"HeadersView",setup(c){return u(()=>{d()}),(n,r)=>(l(),_(h,{title:"Page Headers",breadcrumb:[{label:"Page Sections",route:"/sections/page-sections/page-headers"},{label:"Page Headers"}]},{default:e(()=>[t(v,{title:"Header 1",code:g(K),id:"header-1"},{default:e(()=>[t(I)]),_:1},8,["code"])]),_:1}))}};export{J as default};
